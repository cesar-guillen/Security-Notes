Account management is concerned with creating, managing, disabling and terminating accounts. When the account is active, [[6. Authorization Models|access control]] methods are used to control what the user can do. Additionally, administrators use access controls to control when, where, and how users can log on.
