...
* **Email gateways**: network devices or software applications that act as a barrier between an organization’s internal email system and the external internet, filtering incoming and outgoing emails for spam, [[2. Determining Malware Types|malware]], and other types of threats.
...
##### DNSSEC
One risk with DNS is *[[1. Identifying Network Attacks#^908174|DNS poisoning]]*. When successful, attacker modify the DNS cache with bogus IP addresses. This can be done to send users to a malicious website. 
