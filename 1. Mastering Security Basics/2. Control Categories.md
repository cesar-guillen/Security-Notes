...
*  [[1. Comparing Physical Security Controls|Physical Controls]] impact the physical world, such as locks on doors, fences, security guards, and other objects that you can physically touch.
...
1. **[[1. Understanding Risk Management#Risk Assessment Types|Risk Assessments]]**:  These help quantify the and qualify risks within an organization so that team members can focus on the primary issues.
2. **[[2. Checking for Vulnerabilities#Vulnerability Assessments|Vulnerability Assessments]]**: A vulnerability assessment attempts to discover current vulnerabilities. When necessary, additional controls are implemented to reduce the risk from these vulnerabilities.

## Operational Controls
These are controls that are primarily implemented and executed by people and not systems. 

1. **[[6. Security Awareness|Awareness and Training]]**: Training helps users maintain password security, and understand threats like phishing.
2. **[[2. Implementing Secure Systems#Using Master Images for Baseline Configurations|Configurations Management]]**: The use of baselines ensures that systems start in a secured and hardened state. *Change Management* ensures that changes do not result in unintended config errors
3. **[[2. Implementing Secure Systems|Media Protections]]**: This includes physical media like USB sticks, external and internal drives. etc. This covers encryption and how to act in the event of theft or loss.
...
1. **[[1. Comparing Physical Security Controls#Monitoring Areas with Video Surveillance|Video Surveillance]]**: Videos can be used to protect employees and determine if theft of data is being done. 
2. **[[1. Comparing Physical Security Controls#Sensors|Sensors]]**: Sensors are a more economic way to determine when and where someone passed through, there are many types of sensors. 
3. **[[1. Comparing Physical Security Controls#Access Control Vestibules|Access Control Vestibules]]**: Provide a physical barrier between the outside world and valuable assets.
